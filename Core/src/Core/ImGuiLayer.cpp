...
void SetupImGuiStyle(bool bStyleDark_, float alpha)
{
    ...
    if (bStyleDark_)
    {
        // Very dark theme with subtle blue accents
        colors[ImGuiCol_Text] = ImVec4(0.90f, 0.90f, 0.90f, alpha);
        ...
        colors[ImGuiCol_ScrollbarGrab] = ImVec4(1.0f, 1.0f, 1.0f, 1.0f);
        colors[ImGuiCol_ScrollbarGrabHovered] = ImVec4(0.0f, 0.235f, 1.0f, 1.0f);
        colors[ImGuiCol_ScrollbarGrabActive] = ImVec4(0.392f, 0.533f, 0.988f, 1.0f);
        colors[ImGuiCol_CheckMark] = ImVec4(0.50f, 0.30f, 0.10f, 1.00f);
        colors[ImGuiCol_SliderGrab] = ImVec4(0.216, 0.38, 0.929, 1.00f);
        colors[ImGuiCol_SliderGrabActive] = ImVec4(0.60f, 0.40f, 0.20f, 1.00f);
        colors[ImGuiCol_Button] = ImVec4(0.10f, 0.10f, 0.10f, 1.00f);
        colors[ImGuiCol_ButtonHovered] = ImVec4(0.30f, 0.30f, 0.30f, 1.00f);
        colors[ImGuiCol_ButtonActive] = ImVec4(0.392f, 0.533f, 0.988f, 1.00f);
        colors[ImGuiCol_Header] = ImVec4(0.20f, 0.20f, 0.20f, 0.60f);
        colors[ImGuiCol_HeaderHovered] = ImVec4(0.20f, 0.20f, 0.20f, 0.73f);
        ...
        colors[ImGuiCol_TabUnfocused] = ImVec4(0.10f, 0.10f, 0.10f, 0.56f);
        ...
        colors[ImGuiCol_DragDropTarget] = ImVec4(0.50f, 0.30f, 0.10f, 1.00f);
        colors[ImGuiCol_NavHighlight] = ImVec4(0.50f, 0.30f, 0.10f, 1.00f);
        colors[ImGuiCol_NavWindowingHighlight] = ImVec4(0.50f, 0.30f, 0.10f, 0.70f);
